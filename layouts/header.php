...
<head>
    ...
    <title>POS Premium - Dashboard</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <nav id="sidebar">
        <div class="sidebar-header">
            <a href="index.php" class="sidebar-logo">
                <i class="fas fa-rocket me-2"></i> POS v1
            </a>
        </div>
        ...
        <div class="nav-menu">
            ...
            <div class="nav-item">
                <a href="debts.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'debts.php' ? 'active' : ''; ?>">
            ...
            <div class="nav-item">
                <a href="rbac.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'rbac.php' ? 'active' : ''; ?>">
    ...
    <div id="main-content">
        ...
        <div class="topbar">
            <div class="d-flex align-items-center">
                <h4 class="mb-0 fw-bold text-muted me-3">
                    <?php 
                        ...
                        else if($page == 'products.php') echo 'Product Inventory';
                        else if($page == 'suppliers.php') echo 'Suppliers';
                        else if($page == 'customers.php') echo 'Customers';
                        else if($page == 'pos.php') echo 'Point of Sale';
                        else echo ucfirst(str_replace('.php', '', $page));
                    ?>
                </h4>
            ...
            <div class="d-flex align-items-center">
                ...
                <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($_SESSION['fullname']); ?>&background=764ba2&color=fff" class="rounded-circle" width="40" height="40">
            </div>
        </div>
